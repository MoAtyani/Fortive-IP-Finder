          ...
          <div className="animate-fade-in" style={{ display: 'grid', gridTemplateColumns: '1fr 2.5fr', gap: '32px', maxWidth: '100%', margin: '0 auto', width: '100%' }}>
            ...
            <div className="glass-panel" style={{ display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ flex: 1, background: 'rgba(0,0,0,0.3)', borderRadius: '12px', border: '1px solid var(--glass-border)', overflowX: 'auto', display: 'flex', flexDirection: 'column' }}>
                {/* Table Header */}
                <div style={{ display: 'grid', gridTemplateColumns: '2.5fr 1.5fr 2fr 3fr', minWidth: '900px', padding: '16px', background: 'rgba(255,255,255,0.05)', borderBottom: '1px solid var(--glass-border)', fontWeight: 600, fontSize: '14px' }}>
                  <div>Target</div>
                  <div>Origin IP</div>
                  <div>Source</div>
                  <div>Match Title</div>
                ...
                <div style={{ flex: 1, overflowY: 'auto', padding: '8px' }}>
                  {results.length === 0 ? (
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                      {results.map((res, idx) => (
                        <div key={idx} className="animate-fade-in" style={{ display: 'grid', gridTemplateColumns: '2.5fr 1.5fr 2fr 3fr', minWidth: '900px', padding: '12px 8px', background: 'rgba(255,255,255,0.02)', borderRadius: '8px', fontSize: '14px', alignItems: 'center' }}>
