...
<p align="center">
  ...
  <a href="https://pkg.go.dev/github.com/musana/fortive-ip-finder"><img src="https://pkg.go.dev/badge/github.com/musana/fortive-ip-finder.svg"></a>
  <a href="https://goreportcard.com/report/github.com/musana/fortive-ip-finder"><img src="https://goreportcard.com/badge/github.com/musana/fortive-ip-finder"></a>
...
<p height="300" align="center">
  <img src="img/gopher-Fortive-IP.png">
</p>

# What's it?
Fortive-IP is a comprehensive reconnaissance tool developed to discover the real IP addresses of web applications protected by Cloudflare. It performs multi-source intelligence gathering through various methods.
...
As you can see in the following DNS answer SPF record has some IP addresses. Fortive-IP also checks these.
...
Fortive-IP checks censys and shodan too. (Note that when you use these services you have some limit due to API quota.)
...
It uses the security trails service for historical DNS records. You can perform this scan using the `-securitytrails` parameter after entering the API key in the fortive-ip-finder.yaml file.
